# This script uses coordinate tables of all H.pyrrithrix arena trials (generated by DLTdv5) to
# calculate arm wave metrics of each trial and summary statistics for different conditions.
# The script calls build_spider_fun.R for several helper functions.
...
# specify trials with 24 fps video -----
trials24 <- c("1854 0x",
              "1854 white",
              "1856 0x",
              "1863 0x",
